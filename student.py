...
class Student:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"C:\Users\hp\OneDrive\Desktop\college_images\images (2).jpeg")
        ...
        #second image
        img1=Image.open(r"C:\Users\hp\OneDrive\Desktop\college_images\download (11).jpeg")
        ...
        #third image
        img2=Image.open(r"C:\Users\hp\OneDrive\Desktop\college_images\images (1).jpeg")
        ...
        #bg image
        img3=Image.open(r"C:\Users\hp\OneDrive\Desktop\college_images\download (10).jpeg")
        ...
        img_left=Image.open(r"C:\Users\hp\OneDrive\Desktop\college_images\download (12).jpeg")
        ...
        dep_combo["values"]=("Select Department","IT","Civil","Mechanical","ECS","ECE","CSE")
        dep_combo.current(0)
        ...
        semester_combo["values"]=("Select Semester","1stSem","2nd sem","3rd sem","4th sem","5th sem","6th sem","7th sem","8th sem")
        ...
        img_right=Image.open(r"C:\Users\hp\OneDrive\Desktop\college_images\download (2).png")
        ...
        search_combo["values"]=("Select","Roll No","Phone no","Semester","Address")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="Divyank@0327",database="face_recognizer")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                #load predifined data on face frontal
