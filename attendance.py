...
class Attendance:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"C:\Users\hp\OneDrive\Desktop\college_images\images (4).jpeg")
        ...
        #second image
        img1=Image.open(r"C:\Users\hp\OneDrive\Desktop\college_images\images (3).jpeg")
        ...
        img_left=Image.open(r"C:\Users\hp\OneDrive\Desktop\college_images\images (5).jpeg")
        ...
        left_inside_frame.place(x=0,y=200,width=720,height=400)
        ...
        delete_btn=Button(btn_frame,text="Updatee",width=17,font=("times new roman",13,"bold"),bg="blue",fg="white")
